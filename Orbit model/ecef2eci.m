...
function [reci,veci, T_eci2ecef] = ecef2eci  ( recef,vecef,ttt,jdut1,lod,xp,yp,eqeterms,ddpsi,ddeps,nut80  )

        [prec,psia,wa,ea,xa] = precess ( ttt, '80' );

        [deltapsi,trueeps,meaneps,omega,nut] = nutation(ttt,ddpsi,ddeps,nut80 );
        ...
        T_eci2ecef = pm'*st'*nut'*prec';
        reci = T_eci2ecef'*recef;

        veci = T_eci2ecef'*vecef + T_eci2ecef'*pm'*cross(omegaearth, pm*recef);
